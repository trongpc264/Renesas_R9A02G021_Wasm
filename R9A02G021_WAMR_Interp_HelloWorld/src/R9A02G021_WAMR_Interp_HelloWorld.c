...
#include "hello_world_wasm_c.h"
//#include "hello_world_wasm_rust.h"
...
iwasm_main()
{
    ...
    /*
     * Note: In C program we call malloc(128) ==> heap must >128
     *       In Clang compiler, we define stack stack-size=128 ==> stack must >128
     * */
